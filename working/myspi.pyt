...
#
# myspi.pyt
# fork of https://github.com/WildlifeConservationSocietyCI/spi
#
...
# TODO
# -----
# * implement the max distance threshold
# * deal with update parameters function and handling
#
##############################################################################
# REQUIRED MODULES
##############################################################################
...
class MYARCPYSPI(object):
    ...
    History:  Version 2.0
              ...
              !!! NOTE: 'if name is main' will run tool during import to ArcPro
                        Removed, viola, it runs!
              !!! NOTE: class is instantiated when loaded into ArcPro;
                        therefore, creating the absolute directory paths;
                        this needs a-fixing!
              !!! NOTE: toolbox crashes when a ./Data directory does not exist;
                        this needs a-fixing!
              Version 1.2-arcpy
